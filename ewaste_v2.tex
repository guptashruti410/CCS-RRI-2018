...
\thead{\normalsize{State}} & \thead{\normalsize{Licence}} & \thead{\normalsize{Cost in Rs.}\\ \footnotesize\textit{(For Investment Between 1 and 10 crores)}} & \thead{\normalsize{Official Time Taken}\\ \footnotesize\textit{(in days)}} \\
\hline
...
\begin{tabular}{ l  r  r }
\thead{\normalsize{Name of Recycling Firm}} & \thead{\normalsize{Optimum Capacity} \\ \footnotesize\textit{(in tonnes)}} & \thead{\normalsize{Capacity Utilised for 2017-18} \\ \footnotesize\textit{(in tonnes)}} \\
\hline 
